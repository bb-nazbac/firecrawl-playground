...
from core.domain_cache import DomainCache
...
class PipelineOrchestrator:
    ...
    def __init__(self, config_name: str, args):
        ...
        self.output_dir = outputs_base / self.config.client / self.run_id
        ...
        self.domain_cache = DomainCache(self.output_dir)
